...
function checkBrowser()
{
	...
	if((ua.indexOf('msie') > -1) && (ua.indexOf('opera') == -1) || (ua.indexOf('trident/7') > -1)) {
		g_jafw_userAgent = UA_MSIE;
	}
	// Edge
	else if(ua.indexOf('edge') > -1) {
		g_jafw_userAgent = UA_EDGE;
	}
	// Google Chrome
	else if((ua.indexOf('chrome') > -1) && (ua.indexOf('edge') == -1)) {
		g_jafw_userAgent = UA_CHROME;
	}
	// Firefox
	else if(ua.indexOf('firefox') > -1) {
		g_jafw_userAgent = UA_FIREFOX;
	}
	// Safari
	else if((ua.indexOf('safari') > -1) && (ua.indexOf('chrome') == -1)) {
		g_jafw_userAgent = UA_SAFARI;
	}
	// Opera
	else if(ua.indexOf('opera') > -1) {
		g_jafw_userAgent = UA_OPERA;
	}
}
checkBrowser();

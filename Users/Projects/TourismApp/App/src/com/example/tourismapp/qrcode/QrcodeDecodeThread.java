...
final class QrcodeDecodeThread extends Thread {
    ...
    QrcodeDecodeThread(QrcodeActivity activity, ResultPointCallback resultPointCallback) {
    ...
    public void run() {
        Looper.prepare();
        // スレッドのハンドラを QrcodeDecodeHandler に
        handler = new QrcodeDecodeHandler(activity, hints);

...
// QrcodeActivity 内で生成した本クラスのインスタンスが
// QrcodeDecodeThread ～ QrcodeDecodeHandler 経由でライブラリ側へ渡され
// QR コード識別メソッドから ResultPoint （パターン識別点）情報を添えてコールバックされる
final class QrcodeResultPointCallback implements ResultPointCallback {
    private QrcodeFinderView mFinderView = null;

    QrcodeResultPointCallback(QrcodeFinderView v) {
        mFinderView = v;
    }
